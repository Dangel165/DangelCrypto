...
Copyright (c) 2026 Dangel. All rights reserved.

이 라이브러리는 Dangel의 독점 소유 프로젝트입니다. Dangel의 사전 서면
허가 없이 이 소스 코드, 문서, 테스트, 예제를 복사, 수정, 배포, 재게시,
재패키징, 판매, 호스팅하거나 사용할 수 없습니다.

저장소를 열람하거나 파일을 내려받는 것은 사용권 또는 배포권을 부여하지
않습니다.
